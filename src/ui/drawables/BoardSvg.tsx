  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={innerFill}
        {...stylex.props(styles.clickThrough, styles.atOpacity(opacity))}
      ></path>
      <path
        ...
        fill="#000000"
        {...stylex.props(styles.atOpacity(opacity))}
      ></path>
      <path
...
function Image({ tileKey, y }: { tileKey: TileKey; y?: number }) {
  ...
  return (
    <image
      {...stylex.props(styles.emoji, styles.atOpacity(opacity))}
      x={250 - SIZE / 2}
      y={y - SIZE / 2}
      width={SIZE}
      height={SIZE}
